...
pathLR.src = "../gfx/path_lr.png";
const pathUD = new Image();
pathUD.src = "../gfx/path_ud.png";
const pathDL = new Image();
pathDL.src = "../gfx/path_dl.png";
const pathDR = new Image();
pathDR.src = "../gfx/path_dr.png";
const pathUL = new Image();
pathUL.src = "../gfx/path_ul.png";
const pathUR = new Image();
pathUR.src = "../gfx/path_ur.png";
const empty = new Image();
empty.src = "../gfx/grass.png";
const empty1 = new Image();
empty1.src = "../gfx/grass1.png";
const empty2 = new Image();
empty2.src = "../gfx/grass2.png";
const empty3 = new Image();
empty3.src = "../gfx/flowers.png";
const towerPlace = new Image();
towerPlace.src = "../gfx/tower_spot.png";
